        ...
        return (
            <div>
                ...
                <div className="bodySeine">
                    ...
                    <div className="divPhoto">
                        <Zoom>
                            <img src={require("../../img/seine/le_mesnil-sous-jumieges/le_mesnil-sous-jumieges02.jpg")} alt="le_mesnil-sous-jumieges02" className="photo"/>
                        </Zoom>
                    </div>
                    <div className="divPhoto">
                        <Zoom>
                            <img src={require("../../img/seine/le_mesnil-sous-jumieges/le_mesnil-sous-jumieges03.jpg")} alt="le_mesnil-sous-jumieges03" className="photo"/>
                        </Zoom>
                    </div>
                </div>
            </div>
