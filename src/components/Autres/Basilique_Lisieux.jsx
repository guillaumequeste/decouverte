            ...
            <div>
                ...
                <div className="bodyAutres">
                    ...
                    <div className="container">
                        <p>La basilique Sainte-Thérèse est située à Lisieux, en Normandie. Elle a été élevée en l'honneur de sainte Thérèse de l'Enfant Jésus peu de temps après sa canonisation.
                        Imposant édifice de style néo-byzantin inspiré de la basilique du Sacré-Cœur de Montmartre, sa construction, sur une hauteur en limite de la ville, a débuté en 1929 et sa consécration a eu lieu en 1954. Aujourd'hui, l'édifice accueille plus de 600 000 visiteurs par an1.
                        Labellisée « Patrimoine du xxe siècle »2, elle a été inscrite au titre des monuments historiques le 14 septembre 20103 puis classée le 7 septembre 20114.</p>
                        <p className="lienSiteOfficiel">Site officiel : <a href="https://www.therese-de-lisieux.catholique.fr/lisieux/la-basilique/" target="_blank">Basilique Sainte-Thérèse de Lisieux</a></p>
                    </div>
                    <div className="divPhoto">
                        <Zoom>
