        ...
        return (
            <div>
                ...
                <div className="bodyAutres">
                    ...
                    <div className="divPhoto">
                        <Zoom>
                            <img src={require("../../img/autres/cathedrale_beauvais/cathedrale_beauvais02.jpg")} alt="cathedrale_beauvais02" className="photo"/>
                        </Zoom>
                    </div>
                    <div className="divPhoto">
                        <Zoom>
                            <img src={require("../../img/autres/cathedrale_beauvais/cathedrale_beauvais03.jpg")} alt="cathedrale_beauvais03" className="photoGrosHorloge"/>
                        </Zoom>
                    </div>
                </div>
            </div>
